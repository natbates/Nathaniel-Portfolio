  ...
  if (!item) {
    return (
      <section className="p-4">
        <Link className="detail-item-anim inline-flex items-center gap-2 mb-4 !no-underline" style={{ "--detail-delay": "60ms" }} to="/experience">
          <FaArrowLeft />
          Back to experience
        </Link>
        <h2 className="detail-item-anim text-3xl mb-2" style={{ "--detail-delay": "140ms" }}>Experience not found</h2>
      </section>
    );
  }
