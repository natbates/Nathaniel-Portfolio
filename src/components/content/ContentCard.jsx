...
export default function ContentCard({ item, to }) {
  return (
    <Link to={to} className="w-full md:min-h-0 border p-3 !no-underline opacity-100 md:opacity-70 md:hover:opacity-100 transition-opacity flex flex-col md:flex-row md:items-center gap-4">
